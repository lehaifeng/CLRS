...
num_epochs_per_task = [250,300,300,300,300]
minibatch_size = 64
epoches = 6000
learning_lr = 0.001

data_path=r'./CLRS dataset/CLRS'
label_path=r'./CLRS dataset/label/NC/run1'#NI/NC/NIC
...
name=['task1','task2','task3','task4','task5']#NC
...
file= open('CLRS_LWF_reslution_NC.txt', 'w')
for fp in task_acc:
    file.write(str(fp)+',')
file.close()
sess.close()
