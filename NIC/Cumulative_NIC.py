...
num_epochs_per_task = [300,350,400,400,450,500,500,500,500,500,500,500,500,550,600]
minibatch_size = 64
epoches = 20000
learning_lr = 0.001

data_path=r'./CLRS dataset/CLRS'
label_path=r'./CLRS dataset/label/NIC/run1'  #NI/NC/NIC
...
for task in range(num_tasks_to_run):
    ...
    sess.close()
file = open('CLRS_Cumulative_reslution_NIC.txt', 'w')
for fp in task_acc:
    file.write(str(fp)+',')
file.close()
